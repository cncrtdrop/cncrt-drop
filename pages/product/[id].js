      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 py-8">
        ...
        <div className="grid sm:grid-cols-2 gap-8 sm:gap-12">
          ...
          <div className="flex flex-col">
            ...
            <div className="flex items-center gap-3 text-xs text-neutral-500 mt-3 uppercase tracking-widest flex-wrap">
              ...
              {product.origin_country && (
                <>
                  <span>·</span>
                  <span>Fabriqué en {product.origin_country}</span>
                </>
              )}
            </div>
            ...
            <button
              ...
              disabled={added}
              className={
                "mt-4 border font-bold uppercase tracking-widest text-xs py-3 transition-colors " +
                (added
                  ? "bg-pink-600 border-pink-600 text-white"
                  : "border-neutral-900 text-neutral-900 hover:bg-pink-600 hover:border-pink-600 hover:text-white")
              }
            >
            ...
            {added && (
              <div className="flex gap-2 mt-2">
                <button
                  onClick={() => (window.history.length > 1 ? router.back() : router.push("/"))}
                  className="flex-1 border border-neutral-300 text-neutral-700 text-[10px] uppercase tracking-widest font-bold py-2"
                >
                  Continuer mes achats
                </button>
                <button
                  onClick={() => router.push("/?cart=open")}
                  className="flex-1 bg-neutral-900 text-white text-[10px] uppercase tracking-widest font-bold py-2"
                >
                  Voir le panier
                </button>
              </div>
